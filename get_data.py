...
def preprocess(sample):
    ...
    '''
    sample['play'] = sample['play']/1000
    sample['play_nums'] = sample['play'] / sample['videoplayseconds']
    sample['play_nums'] = sample['play_nums'].apply(lambda x:min(5,x))
    sample['play_nums'] = sample['play_nums'] .fillna(0.0)
    
    sample['videoplayseconds'] = sample['videoplayseconds'].fillna(0.0)
...
if __name__ == "__main__":    
    ...
    for featid in sparse_features:
        ...
        sparse_max_len.append(data[featid].nunique()+1) #0作为未知的userid
